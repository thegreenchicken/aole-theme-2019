<div class="section-container event-section-container" role="main">
	...
	<!--facilist-->
		...
		<div class="event-information-container">
			...
			<div class="event-time">
				<?php echo substr($event["event"]->event_start_time, 0, -3)."-".substr($event["event"]->event_end_time, 0, -3); ?>
			</div>
			<!-- Location -->
			...
			<div class="export-event-to-ical">
				<a href="<?php echo do_shortcode("[event post_id='".$event["post"]->ID."']#_EVENTICALURL[/event]");?>">
					Export to iCal
				</a>
			</div>
			<?php if ($event["event"]->custom_fields["registration_link"]): ?>
				<div class="registration-link">
					<a class="button secondary" href="<?php echo $event["event"]->custom_fields["registration_link"]; ?>">
						Register here
					</a>
				</div>
			<?php endif; ?>
